...
//        System.out.println((open) ? "the door slams shut" : "the door swings open");
        ...
        Dunjeon.getInstance().getSoundManager().exposeSound(new AbsoluteSoundEvent(10, containingCell.getPoint2D(), containingCell.getFloor(), "The door "+action, "A door" + action, AbsoluteSoundEvent.SoundType.PHYSICAL, interactor));
        open = !open;
