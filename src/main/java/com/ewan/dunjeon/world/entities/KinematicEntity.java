...
public abstract class KinematicEntity extends Entity {
    ...
    public KinematicEntity(Color c, String name){
        this.color = c;
        UUID = UUIDcounter;
        this.name = name;
        this.size = 0.5f;
    ...
    public KinematicEntity(Color c, String name, float size){
        this.color = c;
        UUID = UUIDcounter;
        this.name = name;
        this.size = size;
...
//            }
    ...
    public boolean doesCollideWithWall(KinematicEntity e){
        return true;
    }
    ...
    public java.util.List<KinematicEntity> getAttachedEntities(){
