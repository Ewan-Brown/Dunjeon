...
//                return new CellPosition(new Vector2(0,0), floorID);
//            }
//        });
...
//                System.out.println("Writing serverData object");
//            }
//
//            @Override
//            public ServerData read(Kryo kryo, Input input, Class type) {
//                System.out.println("\"Reading\" serverData Object");
//                return new ServerData(new BasicMemoryBank(0));
//            }
//        });
        return kryo;
    }
